...
<?php    
    ...
    if(isset($_POST['submit'])){
        ...
        $atividade = $_POST['status'];

        if($senha == $conf_senha){
            //2. montando a solicitação dos dados a serem inseridos no banco de dados
            $sql = "INSERT INTO admins SET 
                nome_admin='$usuario', e_mail_admin='$email', senha_admin='$senha', ativ_admin='$atividade'
            ";
            ...
            if($res == TRUE){
                ...
                $_SESSION['add'] = 'O admin foi inserido com sucesso';
                header("location: http://localhost/kbrtec-pets/painel/painel-admin.php");
            }else{
             //Redirecionando a página
                header("location: http://localhost/kbrtec-pets/painel/cadastar-admin.php");
            }
        } else{
            $_SESSION['senha_nao'] = "as senhas não são iguais, tente novamente";
            header("location: http://localhost/kbrtec-pets/painel/painel-admin.php");
        }
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex align-items-end justify-content-between mb-4">
                <h1 class="h3">Cadastrar Usuário PHP</h1>

                <a href="painel-admin.php?nome_admin_head=<?php  echo $nome_admin_head; ?>" class="btn btn-light">Voltar</a>
            </div>
            ...
            <form action="" class="bg-custom rounded col-12 py-3 px-4" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control bg-dark text-light border-dark" name="usuario" placeholder="Ex: Admin" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control bg-dark text-light border-dark" name="email" id="email" placeholder="Ex: admin@kbrtec.com.br" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control bg-dark text-light border-dark" name="senha" id="senha" placeholder="Nova Senha" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control bg-dark text-light border-dark" name="confSenha" id="confSenha" placeholder="Confirmação de Nova Senha" required >
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <label for="status">Está Ativo</label>
                    </div>
                </div>
