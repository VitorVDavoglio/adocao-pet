        ...
        <main class="col h-100 text-light p-4">
            ...
            <div class="bg-custom rounded overflow-hidden">
                <table class="table mb-0 table-custom table-dark align-middle">
                    <thead>
                        <tr>
                            <th scope="col" class="text-uppercase">Nome do Pet</th>
                            <th scope="col" class="text-uppercase">Nome Solicitante</th>
                    ...
                    <tbody>
                        <?php 
                            //Query para coletar dados da tabela solicitação
                            ...
                            if ($res==TRUE ) {
                                ...
                                if ($cont_linhas> 0) {
                                    ...
                                    while ($linhas = mysqli_fetch_assoc($res)) {
                                        ...
                                        $nome_pet = $linhas["nome_pet"];
                                        $nome = $linhas["nome_solic"];
                                        $numero = $linhas["data_solic"];
