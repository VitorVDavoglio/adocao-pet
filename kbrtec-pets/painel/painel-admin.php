...
<?php
    ...
    //mostrando a mensagem que as senhas para cadastro não batem
    if (isset($_SESSION['senha_nao'])){
        echo $_SESSION['senha_nao'];
        unset($_SESSION['senha_nao']);
    }
            ...
            <div class="row">
                ...
                <div class="col dropdown d-flex align-items-center justify-content-end">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item text-end" href="editar-admin.php?nome_admin_head=<?php  echo $nome_admin_head; ?>">
                ...
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            ...
                            <a href="painel-admin.php?nome_admin_head=<?php  echo $nome_admin_head; ?>" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                <small class="d-flex justify-content-between align-items-center">
                                    Listagem
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="cadastrar-admin.php?nome_admin_head=<?php  echo $nome_admin_head; ?>" class="btn btn-light">Cadastrar Usuário</a>
                </div>
            </div>
                ...
                <table class="table mb-0 table-custom table-dark align-middle">
                    ...
                    <tbody>
                        <?php 
                            ...
                            //Query para coletar dados da tabela admins
                            //ORDER BY nome_admin
                            $sql = "SELECT * FROM admins LIMIT $inicio, $limite";
                            //Executando
                            ...
                            if ($res==TRUE ) {
                                ...
                                //checando o numero de linhas
                                if ($cont_linhas> 0) {
                                    //Se houver dado da tabela
                                    while ($linhas = mysqli_fetch_assoc($res)) {
                                        //Vai rodar ate o numero de linhas final da tabela
                                        $id = $linhas["cd_admin"];
                                        $nome = $linhas["nome_admin"];
                                        $email = $linhas["e_mail_admin"];
                                        $senha = $linhas["senha_admin"];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <button type="button" name="id=<?php echo $id; ?>" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                                                        </svg>
                                                    </button>

                                                    <a href="editar-admin.php?id=<?php echo $id; ?>&nome_admin_head=<?php  echo $nome_admin_head; ?>" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
                                                    ...
                                                    <a href="deletar-admin.php?id=<?php echo $id; ?>" class="btn btn-danger d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Deletar">
                                    ...
                                    //Se não houver nenhhum dado na tabela
                                }
                            }
                        ?>
                    </tbody>
            ...
            <nav aria-label="navigation">
                <ul class="pagination justify-content-end pt-4 pb-2">
                    ...
                    <li class="page-item"><a class="page-link bg-custom border-dark link-light" href="http://localhost/kbrtec-pets/painel/painel-admin.php?nome_admin_head=<?php  echo $nome_admin_head; ?>&pagina=1">1</a></li>
                    <li class="page-item"><a class="page-link bg-custom border-dark link-light" href="http://localhost/kbrtec-pets/painel/painel-admin.php?nome_admin_head=<?php  echo $nome_admin_head; ?>&pagina=2">2</a></li>
