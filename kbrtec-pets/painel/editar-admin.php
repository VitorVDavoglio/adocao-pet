...
<body class="bg-dark h-100">
        ...
        <main class="col h-100 text-light p-4">
            ...
            <?php 
                ...
                if($res==TRUE){
                    ...
                    if($contagem==1){
                        ...
                        $usuario = $row['nome_admin'];
                        $email = $row['e_mail_admin'];
            ...
            <form action="" class="bg-custom rounded col-12 py-3 px-4" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control bg-dark text-light border-dark" id="usuario" name="usuario" placeholder="Ex: Admin" value="<?php echo $usuario; ?>">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control bg-dark text-light border-dark" id="email" name="email" placeholder="Ex: admin@kbrtec.com.br" value="<?php echo $email; ?>">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="input" class="form-control bg-dark text-light border-dark" id="senha" name="senha" value="<?php echo $senha; ?>">
                    </div>
                </div>

                <div class="d-flex justify-content-end">
                    <button type="submit" name="submit" class="btn btn-light">Salvar</button>
                </div>
            </form>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="UPDATE admins SET nome_admin = '$usuario', e_mail_admin = '$email', senha_admin = '$senha' WHERE cd_admin = $id";
