...
<body class="bg-dark h-100">
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="cadastrar-pet.php?nome_admin_head=<?php  echo $nome_admin_head; ?>" class="btn btn-light">Cadastrar Usuário</a>
                </div>
            </div>
                ...
                <form action="" class="bg-custom rounded col-12 py-3 px-4">
                    ...
                    <div class="row align-items-end row-gap-4">
                        <div class="col-3 d-flex flex-wrap">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control bg-dark text-light border-dark" id="search" name="buscar_admin"placeholder="Ex: Admin">
                            </div>
                        </div>
                        ...
                        <div class="col d-flex justify-content-end">
                            <button type="submit" name="submit2"class="btn btn-light w-100">Filtrar</button>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <tbody>
                        <?php
                            if(isset($_SESSION['submit2'])){
                                ...
                                $sql = "SELECT * FROM pets WHERE nome_admin='buscar_admin'";
                            }else{
                                //Query para coletar dados da tabela pets
                            ...
                            if($res == TRUE){
                                ...
                                if ($cont_linhas > 0){
                                    ...
                                    while ($linhas = mysqli_fetch_assoc($res)) {
                                        ...
                                        //procurar os parents do type button e obter os valores do childs
                                        ?>
                                            <tr"> 
                                                <td class="id-cell"><?php echo $id ?></td>
                                                <td class="id-cell2"><?php echo $nome ?></td>
                                                <td><?php echo $raca ?></td>
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" data-bs-toggle="modal" data-bs-target="#exampleModal" name="id=<?php echo $id ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                                                            </svg>
                                                        </button>

                                                        <a href="editar-pet.php?id=<?php echo $id; ?>&nome_admin_head=<?php  echo $nome_admin_head; ?>" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
                                                        ...
                                                        <a href="deletar-pet.php?id=<?php echo $id; ?>" class="btn btn-danger d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Deletar">
    ...
    <script>
        //Utilizado para identificar o id da linha do botão clicado
        document.addEventListener("DOMContentLoaded", function () {
            // Encontra todos os botões com a classe 'btn-light' .
            var buttons = document.querySelectorAll(".btn-light");

            buttons.forEach(function (button) {
                button.addEventListener("click", function () {
                    // Encontra o elemento com a classe 'id-cell' no mesmo <tr>.
                    var idCell = this.closest("tr").querySelector(".id-cell");
                    
                    // Obtém o valor do ID a partir da célula.
                    var id = idCell.textContent;

                    // Atualiza o conteúdo do modal com o valor do ID.
                    var modalIdElement = document.querySelector(".modal-body .col-6 div:last-child");
        ...
        <div class="modal-dialog modal-dialog-centered text-light">
            <div class="modal-content bg-custom">
                ...
                <div class="modal-body d-flex flex-wrap row-gap-4">
                    ...
                    <div class="col-6">
                        <div><small>Localidade:</small></div>
                        <div></div>
                    </div>
